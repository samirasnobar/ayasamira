...
namespace WindowsFormsApplication10
{
    public partial class Form1 : Form
    {
        ...
        private void checkwinner()
        {
            ...
            else if ((b1.Text == a2.Text) && (b2.Text == b3.Text) && (!b1.Enabled))
            {
                i = true;
            }
            ...
            if (i)
            {
                ...
                {
                    int a = Convert.ToInt32(player1.Text);
                    a++;
                    player1.Text = a.ToString();
                    s = player1.Text;
                    enabedbuttons();
                }
        ...
        private void nweGameToolStripMenuItem_Click(object sender, EventArgs e)
        {
            enabedbuttons();
            O.Text = "0";
            d.Text = "0";
